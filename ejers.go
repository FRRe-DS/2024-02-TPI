...
func impuesto aplicar(monto_acumulado) float64{
	
}

//IVA es una especializacion de Impuesto
type IVA impuesto {
	alicuota int64
}
...
func ciudad Recaudar(){
	
}

func ciudad TieneDeuda() bool{
...
func provincia ciudadEnDeficit(){}
